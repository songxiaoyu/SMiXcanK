#!/usr/bin/env python3
"""Lift HERMES HF GWAS summary statistics from hg19 to hg38.
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Lift HERMES HF hg19 GWAS to hg38."
    )
...
def normalize_hermes_chunk(chunk):
    ...
    if missing:
        raise ValueError(f"HERMES HF GWAS is missing columns: {', '.join(missing)}")
