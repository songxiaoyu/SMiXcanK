...
analysis_dir <- file.path(paper_dir, "Results", "3pi_workspace")
bcac_input_dir <- file.path(analysis_dir, "baca2020_input")
ld_input_dir <- file.path(analysis_dir, "bcac2020_filtered_id")
result_dir <- file.path(paper_dir, "Results", "SMiXcanK_results")
...
for(chr in 1:22){
  ...
  result_path <- file.path(result_dir, sprintf("bcac2020_chr%d_result_pi3_02.csv", chr))
...
combined_path <- file.path(result_dir, "bcac2020_result_pi3_02.csv")
